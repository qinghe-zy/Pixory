...
export function AiActiveSpectrum({ mini = false, barColors, maxHeightScale = 1, alignItems }: AiActiveSpectrumProps) {
  ...
  return (
    ...
    >
      <AiActiveSpectrumBar barColors={barColors} delay={0} index={0} maxHeight={(mini ? 10 : 12) * maxHeightScale} minHeight={4} theta={theta} width={w} />
      <AiActiveSpectrumBar barColors={barColors} delay={150} index={1} maxHeight={(mini ? 14 : 18) * maxHeightScale} minHeight={mini ? 6 : 8} theta={theta} width={w} />
      <AiActiveSpectrumBar barColors={barColors} delay={300} index={2} maxHeight={(mini ? 12 : 14) * maxHeightScale} minHeight={mini ? 4 : 6} theta={theta} width={w} />
      <AiActiveSpectrumBar barColors={barColors} delay={450} index={3} maxHeight={(mini ? 8 : 10) * maxHeightScale} minHeight={mini ? 3 : 4} theta={theta} width={w} />
    </View>
  );
}
