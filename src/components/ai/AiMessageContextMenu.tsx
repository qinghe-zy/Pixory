...
export type AiMessageContextMenuAction = {
  disabled?: boolean;
...
type AiMessageContextMenuProps = {
  actions: AiMessageContextMenuAction[];
  anchorX: number;
  anchorY: number;
  onClose: () => void;
  timeLabel: string;
