...
const styles = StyleSheet.create({
  screen: { flexGrow: 1, gap: 0, paddingHorizontal: spacing[4] },
  ...
  tabsSection: { marginTop: rhythm.fieldContentGap },
  chips: { flexDirection: 'row', gap: rhythm.microGap },
  content: { marginTop: rhythm.heroToListGap },
  ...
  empty: { ...typography.textStyles.body, color: colors.text.tertiary, marginTop: 0, textAlign: 'center' },
