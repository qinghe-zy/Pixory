...
render_start = code.find('const rightAction = (')
if render_start == -1:
...
new_render = '''
  ...
  const headingNode = (
    <Animated.View style={[{ paddingTop: statusBarHeight + 12, paddingHorizontal: layout.pagePaddingHorizontal, paddingBottom: 16 }, heroStyle]}>
