...
| 日期 | 版本 | 更新摘要 |
| --- | --- | --- |
| 2026-06-24 | 2.5.1 | 新增 AI 连续性导入、导入记忆审读门禁、聊天附件可回放，并修复模型删除清理与视频播放器随机逻辑 |
| 2026-06-24 | 2.5.1 OTA | 补齐外部 txt/md 解析不足时的模型辅助结构恢复、导入评审显式 fan-out、会话内直达角色卡导入与小型回退提示，以及模型长按多选批量清理 |
