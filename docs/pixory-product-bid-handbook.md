...
Pixory 支持通过 Gitee raw JSON 提供轻量远程更新和公告。
...
| 日期 | 版本 | 更新摘要 |
| --- | --- | --- |
| 2026-06-13 | 2.4.5 | 优化 AI 工作台最近角色与最近聊天布局，过滤空白新聊天历史，并将应用内更新默认切到 Gitee Releases |
| 2026-06-09 | 2.4.4 | 继续优化 AI 聊天长会话渲染，并在发布前 review 中修复分支回看、搜索定位和内联编辑风险 |
| 2026-06-09 | 2.4.3 | AI 聊天检索改成关键词优先，消息历史版本按需加载，并修复旧版本回看与分支切换显示错误 |
| 2026-06-01 | 2.4.2 | AI 聊天新增整页搜索与 AI 消息收藏，优化分支路线记忆和长聊天定位 |
| 2026-05-30 | 2.4.1 | 聊天历史回收站新增移出回收站入口，支持单条和批量恢复，永久删除继续独立保留 |
| 2026-05-29 | 2.4.0 | 新增 AI 创作路线树，支持关键分支查看、多分支折叠、主路线持久化和路线数据导入导出保护 |
| 2026-05-26 | 2.3.9 | 进一步修复 AI 聊天 Markdown Android 遮挡问题，并加入 EAS Update 热更新底包能力 |
| 2026-05-26 | 2.3.7 | 修复 AI 聊天 Markdown 代码块 Android 遮挡问题，支持离开聊天页后继续生成并在最近列表标记当前聊天 |
| 2026-05-26 | 2.3.6 | 优化 AI 角色详情海报式展示、角色内容卡片和聊天输入框键盘适配 |
| 2026-05-26 | 2.1.21 | 修复 AI 会话资料、知识库资料、IP snapshot、资料删除迁移、总资料库展示和长对话性能体验 |
| 2026-05-25 | 2.1.20 | 修复综合记录抽屉覆盖范围、最近项删除确认、回到最新按钮浮层和触发阈值 |
| 2026-05-25 | 2.1.19 | 修复 AI 聊天编辑分支、记忆检索隔离、综合记录抽屉最近项操作、思考过程折叠显示、角色头像区域压缩和输入框边框 |
| 2026-05-23 | 2.1.14 | 优化 AI 高级角色指令权重、历史会话和回复时间显示、消息版本切换顺序、会话重命名/删除，以及重写和重新生成的独立思考计时；数据库 schema 升至 21 |
| 2026-05-25 | 2.1.18 | 修复角色卡导入编辑后的元数据保留、草稿覆盖保护和原卡更新路径，并补充新聊天输入框浮出提示 |
