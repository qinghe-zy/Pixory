...
[访问官网](https://mist01.com/) · [下载最新版 APK](https://github.com/qinghe-zy/Pixory/releases/latest) · 当前版本 `2.1.21`
...
这一版集中修复 AI 资料库和长对话体验：

- 会话资料、知识库资料和 IP snapshot 的检索、删除、迁移、刷新行为更可靠。
- 总资料库展示、批量删除、当前会话添加资料和文本阅读器流程更清楚。
- AI 聊天补上冷启动问候、思考动画优化、图片 Markdown 渲染和 Android 键盘稳定性。
- 长对话历史加载增加分块查询和 FlatList 驻留控制，减少千级消息场景下的卡顿风险。
