...
[访问官网](https://mist01.com/) · [下载最新版 APK](https://github.com/qinghe-zy/Pixory/releases/latest) · 当前版本 `2.1.20`
...
这一版继续补强综合记录抽屉和聊天浮动按钮体验：

- 综合记录抽屉现在覆盖完整聊天页，打开时不再被标题栏和内容内边距截断。
- 最近会话删除确认改为当前位置轻量确认块，删除按钮使用危险色。
- 回到最新按钮改为独立浮动按钮，减少白色包裹对显示面积的影响。
- 回到最新触发阈值提升，用户轻微离底时不再过早提示。
