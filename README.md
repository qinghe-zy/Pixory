...
[访问官网](https://mist01.com/) · [下载最新版 APK](https://github.com/qinghe-zy/Pixory/releases/latest) · 当前版本 `2.4.1`
...
这一版补齐聊天历史回收站的恢复入口，让误移入回收站的会话更容易回到历史列表：

- 回收站单条会话菜单新增“移出回收站”，与“永久删除”分开显示。
- 回收站批量选择时可批量移出回收站，整理历史记录更直接。
- 左滑回收站会话可快速移出，普通历史仍保持移入回收站流程。
- 延续 AI 创作路线树能力，长对话分支查看和返回定位继续可用。
