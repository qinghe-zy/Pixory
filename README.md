...
[访问官网](https://mist01.com/) · [下载最新版 APK](https://github.com/qinghe-zy/Pixory/releases/latest) · 当前版本 `2.1.14`
...
这一版继续打磨 AI 聊天和会话设置体验：

- 高级角色指令新增默认/高权重，默认保持原行为，高权重使用更明确的会话角色约束。
- 聊天历史显示上次聊天时间，AI 回复操作栏显示分钟级回复时间。
- 消息版本切换统一放在编辑/重新生成按钮后方。
- 修复重写、重新生成时思考计时累加的问题。
- 会话设置支持重命名和删除当前会话。
