...
[访问官网](https://mist01.com/) · [下载最新版 APK](https://github.com/qinghe-zy/Pixory/releases/latest) · 当前版本 `2.1.6`
...
- AI 聊天支持流式输出，回复生成过程可以边生成边显示。
- 保存并测试连接时，会先保存当前模型账号设置，再执行连接测试。
- 默认聊天供应商会被明确记住，高级模型选项也做了收拢。
