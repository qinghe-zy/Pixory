...
[访问官网](https://mist01.com/) · [下载最新版 APK](https://github.com/qinghe-zy/Pixory/releases/latest) · 当前版本 `2.3.6`
...
这一版集中优化 AI 角色详情页和聊天输入体验：

- AI 角色详情页升级为海报式大图布局，角色头像、名称、简介和标签更聚焦。
- 角色指令、默认开场白和更多开场白改为轻量内容卡片，展开和查看更多路径更清楚。
- 聊天页输入框聚焦时主动避让 Android 键盘并跟随最新消息，降低输入区被遮挡的概率。
- 角色详情视觉 token 和分区展开状态更一致，方便后续继续维护。
