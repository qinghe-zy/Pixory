...
[访问官网](https://mist01.com/) · [下载最新版 APK](https://github.com/qinghe-zy/Pixory/releases/latest) · 当前版本 `2.1.7`
...
这一版继续完善 AI 聊天输入、消息操作和视觉一致性：

- AI 聊天输入框支持添加图片、视频和文档附件。
- 长按消息可复制、修改，长按 AI 回复可重新生成。
- 聊天页与弹窗统一使用新的浅色花纹背景。
